...
public class BranchingStructureIf {
    public static void main(String[] args) {
         ...
         * 
         * 奖励： 95~100 山地自行车一辆 90~94 游乐场玩一次 80~89 变形金刚玩具一个 80以下 胖揍一顿
         */
        ...
        // 为每种判断设置对应的奖励
        /*
         * if(score>=95 && score<=100) { System.out.println("山地自行车一辆"); } else
         * if(score>=90 && score<=94) { System.out.println("游乐场玩一次"); } else
         * if(score>=80 && score<=89) { System.out.println("变形金刚玩具一个"); } else {
