package src.basic.javaApi.myObject.object_01;
...
public class ObjectDemo {
    public static void main(String[] args) {
        ...
        /*
         * public void println(Object x) { //x = s; String s = String.valueOf(x);
         * synchronized (this) { print(s); newLine(); } }
         * 
         * public static String valueOf(Object obj) { //obj = x; return (obj == null) ?
         * "null" : obj.toString(); }
         * 
